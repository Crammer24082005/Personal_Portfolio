...
(function () {
    ...
    const TRANSLATIONS = {
        en: {
            ...
            // Doc titles
            'title.home': 'Arnav Khandelwal | AI Engineer',
            'title.projects': 'Arnav | Projects',
            'title.blog': 'Arnav | Blog',
            'title.resume': 'Arnav | Resume',

            // Home / hero
            'hero.label': 'Arnav Khandelwal // AI Engineer // India',
            'hero.subtitle_line1': 'AI & ML ENGINEER //',
            ...
            'home.projects.seo_desc': 'OCR + GenAI based real time assistant.',
            'home.projects.openweather_desc': 'AI-powered scam detection API.',
            'home.projects.scoring_desc': 'Deep learning model for classifying breast cancer histopathological images. Utilizes CNN architectures for automated diagnosis and prognosis.',
            ...
            'cv.subtitle': '# years building data and ML systems at scale.',
        ...
        es: {
            ...
            'footer.copy': '© 2026 Arnav Khandelwal. Hecho con código.',
        ...
        fr: {
            ...
            'status.copenhagen': 'Copenhague',
            'footer.copy': '© 2026 Arnav Khandelwal. Conçu avec du code.',
    ...
    const GREETINGS = [
        ...
        { lang: 'ar', text: 'مرحبًا، أنا Arnav !',         dir: 'rtl' },
